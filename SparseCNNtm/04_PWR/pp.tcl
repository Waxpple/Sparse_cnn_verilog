...
#set DESIGN "alu"
read_verilog ../02_SYN/Netlist/SparseCNN_syn.v
current_design SparseCNN
link

#read_sdc Lab4_alu.sdc
read_sdf -load_delay net ../02_SYN/Netlist/SparseCNN_syn.sdf

#======================================================
#  4. Read Switching Activity File
#======================================================
read_vcd -strip_path TESTBED/SPARSECNN_CORE ../03_GATESIM/SPARSECNN_GATE.vcd
